...
from methods.mdlinear.utils.feature_engineering import construct_features

warnings.filterwarnings('ignore')


def parse_data(df, loc_file):
    ...
    df = df.reset_index()
    df = construct_features(df, loc_file)
    return df


class Dataset_Custom(Dataset):
    def __init__(self, data_file, loc_file, flag='train', size=None, target='Patv', scale=False, **kwargs):
    ...
    def __read_data__(self):
        ...
        df_raw = parse_data(df_raw, self.loc_file)
...
class Dataset_Pred(Dataset):
    def __init__(self, data_file, loc_file, size=None, target='Patv', scale=False, scaler=None, **kwargs):
